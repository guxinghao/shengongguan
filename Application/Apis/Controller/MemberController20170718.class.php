...
class MemberController extends BaseController {
    ...
    public function userlist(){
        ...
        $start=($p-1)*$pages;
          ...
          if($uid==0){
            $smaps['store_id']=array('in',$store_id);
            ...
            $mpas['store_id']=array('in',$store_id);
    ...
    public function index(){
        ...
        $vmaps['store_id']=array('in',$store_id);
        ...
        $mapsss['store_id']=array('in',$store_id);
    ...
    public function shipping_list(){
        ...
        if($role_id>2){
            ...
            $maps['store_id']=array('in',$store_id);
        }
