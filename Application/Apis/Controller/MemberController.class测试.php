...
class MemberController extends BaseController {
    ...
    public function getUser(){
        ...
        $mapss['admin_id']=$user['first_leader'];

        $admin=M("Admin")->where($mapss)->find();

        $vmaps['store_id']=$admin['store_id'];
    ...
    public function index(){
        ...
        $member['dianzhang']=$store['shopkeeper'];
        $member['store_name']=$store['store_name'];
        $member['store_address']=$store['store_address'];
        $member['store_tel']=$store['store_tel'];
    ...
    public function addCart(){
        ...
        $adata['add_time']=time();
        $datas['store_id']=$_REQUEST['store_id'];
        ...
        if($order){
            ...
            foreach ($arr as $key => $value) {
              ...
              $list['pay_points']=$user['pay_points'];
              $list['data']=$arr;
    ...
    public function sale_count(){
       ...
       // $end_time=strtotime($end_time); 
        ...
        $order_goods=D("order_goods")->where($where)->group('spec_key')->select();

        if($order_goods){
            foreach ($order_goods as $key => $value) {
                $where['spec_key']=$value['spec_key'];
    ...
    public function search_sale(){
        ...
        if($order_goods==false){
            $news = array('code' =>0 ,'msg'=>'该商品不存在！','data'=>null);
                echo json_encode($news,true);exit;
        }
    ...
    public function user_sate(){
        ...
        $member['shou_time']=date('Y-m-d',$firstOrder['add_time']);
        $member['end_time']=date('Y-m-d',$endOrder['add_time']);
    ...
    public function huiyuanlist(){
        ...
        $maps['store_id']=$_REQUEST['store_id'];
