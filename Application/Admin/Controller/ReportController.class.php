...
class ReportController extends BaseController{
	...
	public function userTop(){
		...
		$sql .= " on a.user_id = b.user_id where a.add_time>$this->begin and a.add_time<$this->end and a.pay_status=1 $where group by user_id order by amount DESC limit $start,$pageCount";
	...
	public function saleList(){
		...
		$sql .= "  order by add_time desc limit $start,$pageCount";
		$res = M()->query($sql);
		$this->assign('list',$res);
